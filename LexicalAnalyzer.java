...
public class LexicalAnalyzer extends IO{
	...
	**/
	...
	public static void main(String[] args) {
		...
		// args[0]: input file containing source code using tokens defined above
		// args[1]: output file displaying a list of the tokens
